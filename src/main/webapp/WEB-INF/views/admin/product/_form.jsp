	...
	<div class="panel-body">
		<form:form action="${base}/index" modelAttribute="entity"
			...
			<div class="row">
				...
				<div class="form-group col-sm-6">
					<label>Đơn giá:</label>	
					<form:input id="dongia" path="unitPrice" class="form-control" />
				</div>
				<script>
				
				document.getElementById("dongia").value=${entity.unitPrice}.toLocaleString();
				console.log(document.getElementById("dongia").value)
				</script>
			</div>
			<div class="row">
				<div class="form-group col-sm-6">
