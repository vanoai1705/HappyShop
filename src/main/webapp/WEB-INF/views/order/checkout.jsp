		...
		<div class="dang-nhap">
			...
			<form:form action="/order/checkout" modelAttribute="order"
				...
				<div class="form-group">
					...
					<form:input path="rPeople" class="form-control" />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<form:input path="telephone" pattern="[0-9]+" title="Please type number"  class="form-control" />
				</div>
				<div class="form-group">
					<label>Địa chỉ:</label>
					<form:input path="address" pattern="[a-z A-Z 0-9]+"  class="form-control" />
				</div>
				<div class="form-group">
